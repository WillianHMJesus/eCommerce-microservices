...
public sealed class MongoDbManager : IDatabaseReadManager
{
    ...
    public MongoDbManager(IOptions<CatalogDatabaseSettings> catalogDatabaseSettings)
    {
        ...
        _productsCollection = database.GetCollection<ProductDTO>("Products");
        _categoriesCollection = database.GetCollection<CategoryDTO>("Categories");
    }
