...
public sealed class MakeAvailableProductCommandHandler : ICommandHandler<MakeAvailableProductCommand>
{
    ...
    public MakeAvailableProductCommandHandler(
    ...
    public async Task<Result> Handle(MakeAvailableProductCommand request, CancellationToken cancellationToken)
    {
